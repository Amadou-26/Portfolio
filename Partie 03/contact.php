...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['form_contact'])) {
    ...
    if (empty($contact_erreurs)) {
        ...
        $stmt->execute([$contact_nom, $contact_email, $contact_message]);
        $contact_succes = true;
    ...
    <div class="container contact-grid">
      ...
      <aside class="contact-info">
        ...
        <div class="contact-info__item">
          <span>📧</span>
          <div><strong>E-mail</strong><span>papaamadouthomas@email.com</span></div>
        </div>
        <div class="contact-info__item">
          <span>📍</span>
          <div><strong>Localisation</strong><span>Dakar, Sénégal</span></div>
        </div>
        <div class="contact-info__item">
          <span>🐙</span>
      ...
      <div class="form-wrapper">
        ...
        <?php if ($contact_succes) : ?>
          <div class="alert alert-success">
            ✅ Merci ! Ton message a bien été reçu.
          </div>
        <?php endif; ?>
          ...
          <div class="cform__row">
            <div class="cform__group">
              ...
              <input class="cform__input <?= isset($contact_erreurs['nom']) ? 'invalid' : '' ?>"
                     ...
                     value="<?= htmlspecialchars($contact_nom) ?>" required />
            ...
            <div class="cform__group">
              ...
              <input class="cform__input <?= isset($contact_erreurs['email']) ? 'invalid' : '' ?>"
                     ...
                     value="<?= htmlspecialchars($contact_email) ?>" required />
  ...
  <section class="section project-request-section" id="projet">
    <div class="container">
      ...
      <?php if ($projet_succes) : ?>
        <div class="alert alert-success">
          ✅ Demande reçue ! Je te contacte dès que possible.
        </div>
      <?php endif; ?>
        ...
        <div class="cform__row">
          <div class="cform__group">
            ...
            <input class="cform__input <?= isset($projet_erreurs['nom']) ? 'invalid' : '' ?>"
                   ...
                   placeholder="Votre nom"
                   value="<?= htmlspecialchars($demande['nom']) ?>" required />
        ...
        <div class="cform__row">
          <div class="cform__group">
            ...
            <select class="cform__select <?= isset($projet_erreurs['type']) ? 'invalid' : '' ?>"
              ...
              <option value="" disabled <?= $demande['type'] === '' ? 'selected' : '' ?>>
                Sélectionner…
              </option>
